...
Route::group(['prefix' => 'admin', 'middelware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['CekLogin:kasir']], function () {
        Route::resource('orderkasir', OrderController::class);
        Route::resource('orderdetailkasir', OrderDetailController::class);
    });
    ...
    Route::group(['middleware' => ['CekLogin:manager']], function () {
        ...
        Route::get('print', [OrderDetailController::class, 'print']);
