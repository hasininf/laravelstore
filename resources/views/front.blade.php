...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="/">Soki Resto</a>
    ...
    <div class="collapse navbar-collapse justify-content-md-end" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#"> {{ session('logined')['email'] }}</a>
        </li>
        <li class="nav-item">
   ...
   <div class="row">
        <div class="col-3">
            <ul class="list-group">
                ...
                <a href="{{ url('show/'.$kategori->idkategori) }}" style="text-decoration: none"><li class="list-group-item">{{ $kategori->kategori }}</li></a>
                @endforeach
            </ul>
        </div>
        <div class="col-9">
